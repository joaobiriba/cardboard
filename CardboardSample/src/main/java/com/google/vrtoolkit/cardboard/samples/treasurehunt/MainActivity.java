 ...
 */
public class MainActivity extends CardboardActivity implements CardboardView.StereoRenderer, WaveGestureListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        waveGestureHandlerSnap = new WaveGestureHandler(getApplicationContext());
        // set additional information in order to
        waveGestureHandlerSnap.setUsageTrackingDetails("glaquidara@gmail.com", getResources().getString(R.string.app_name));

        SnapSensorAdapter proximitySensorAdapter = new SnapSensorAdapter(waveGestureHandlerSnap, this);
        waveGestureHandlerSnap.setSensorAdapters(proximitySensorAdapter);
